...
for (const [family, leftDoc, rightDoc, anchors] of families) {
  ...
  for (const pair of pairs) {
    ...
    groups.push({
      schema_version: "v5-r2.16-predeclared-candidate-group-1",
      candidate_group_id: `r2.16-pre-${sha256(
...
const manifest = {
  schema_version: "v5-r2.16-predeclared-candidate-group-manifest-1",
