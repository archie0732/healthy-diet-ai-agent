...
export const R216ConfirmationAnnotationSchema = z.object({
  schema_version: z.literal("v5-r2.16-confirmation-annotation-1"),
...
export type R216ConfirmationAnnotation = z.infer<
  typeof R216ConfirmationAnnotationSchema
>;
