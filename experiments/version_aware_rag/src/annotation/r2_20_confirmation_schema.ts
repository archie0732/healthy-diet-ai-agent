import { z } from "zod";
import { R211EvidenceSchema, R211StratumSchema } from "./r2_11_schema";

export const R220ConfirmationAnnotationSchema = z.object({
  schema_version: z.literal("v5-r2.20-confirmation-annotation-1"),
  ...
  review: z.object({
    ...
    r2_12_outcomes_used: z.literal(false),
    r2_13_outcomes_used: z.literal(false),
    r2_14_outcomes_used: z.literal(false),
    r2_15_outcomes_used: z.literal(false),
    r2_16_outcomes_used: z.literal(false),
    r2_17_outcomes_used: z.literal(false),
    r2_18_outcomes_used: z.literal(false),
    r2_19_outcomes_used: z.literal(false),
  }),
});

export type R220ConfirmationAnnotation = z.infer<
  typeof R220ConfirmationAnnotationSchema
>;
