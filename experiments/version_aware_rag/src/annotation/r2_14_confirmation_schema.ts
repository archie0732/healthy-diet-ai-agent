...
export const R214ConfirmationAnnotationSchema = z.object({
  schema_version: z.literal("v5-r2.14-confirmation-annotation-1"),
...
export type R214ConfirmationAnnotation = z.infer<
  typeof R214ConfirmationAnnotationSchema
>;
