...
export function getFewShotPrompt(oldText: string, newText: string): string {
  return `
Example 1:
Old Guideline: "Limit saturated fat intake to less than 10 percent of calories per day starting at age 2."
New Guideline: "Include full-fat dairy with no added sugars. Dairy is an excellent source of protein, healthy fats."
Result: {
...
Example 2:
Old Guideline: "Sodium-Less than 2,300 milligrams per day starting at age 14. Keep intakes lower for children younger than age 14."
New Guideline: "The general population, ages 14 and above, should consume less than 2,300 mg per day of sodium. Highly active individuals may benefit from increased sodium intake to offset sweat losses."
Result: {
